...
<head>
    ...
    <link rel="stylesheet" href="ttps://fonts.googleapis.com/css?family=Poppins:600&display=swap">
	...
	<div class="container">
		...
		<div class="login-content">
			<form action="display.php">
                ...
                <p class="register">Don't have an account? <a href="user.php">Register Here</a></p>
            </form>
